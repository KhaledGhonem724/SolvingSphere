...
Route::prefix('problems')->group(function () {
    ...
    // not used yet
    Route::get('/{problem}/submissions', [SubmissionController::class, 'index_by_problem'])->middleware('auth')->name('problem.submissions');
    Route::post('/{problem}/submissions/create', [SubmissionController::class, 'store'])->middleware('auth')->name('submissions.store');
    Route::get('/{problem}/submissions/create', [SubmissionController::class, 'create'])->middleware('auth')->name('submissions.create');
});
